...
(function() {
  ...
  function updateCarousel() {
    cards.forEach((card, index) => {
      card.classList.remove('active', 'upcoming', 'prev');
  ...
  function nextSlide() {
    ...
    updateCarousel();
    // Reset timer after auto-advance to ensure consistent timing
    resetAutoSlide();
  }
  ...
  document.addEventListener('keydown', (e) => {
    // Only handle if projects section is visible and in focus context
